...
public class CannotUseBeforeEnrollAccountException extends AbstractException {
  final static ExceptionCode code = ExceptionCode.CANNOT_USE_BEFORE_ENROLL_ACCOUNT;
