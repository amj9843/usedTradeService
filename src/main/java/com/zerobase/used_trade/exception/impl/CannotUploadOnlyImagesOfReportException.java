...
public class CannotUploadOnlyImagesOfReportException extends AbstractException {
  final static ExceptionCode code = ExceptionCode.CANNOT_UPLOAD_ONLY_IMAGES_OF_REPORT;
