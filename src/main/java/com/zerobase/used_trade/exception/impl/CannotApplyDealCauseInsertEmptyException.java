...
public class CannotApplyDealCauseInsertEmptyException extends AbstractException {
  final static ExceptionCode code = ExceptionCode.CANNOT_APPLY_DEAL_CAUSE_INSERT_EMPTY;
