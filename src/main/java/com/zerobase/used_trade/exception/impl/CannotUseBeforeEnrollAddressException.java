...
public class CannotUseBeforeEnrollAddressException extends AbstractException {
  final static ExceptionCode code = ExceptionCode.CANNOT_USE_BEFORE_ENROLL_ADDRESS;
