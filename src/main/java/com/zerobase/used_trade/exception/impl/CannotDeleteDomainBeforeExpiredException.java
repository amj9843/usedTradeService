...
public class CannotDeleteDomainBeforeExpiredException extends AbstractException {
  final static ExceptionCode code = ExceptionCode.CANNOT_DELETE_DOMAIN_BEFORE_EXPIRED;
